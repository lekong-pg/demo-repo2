...
module qsys_top_altera_merlin_axi_slave_ni_1971_rxt43ga
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    qsys_top_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_tyvyr4a #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_2n65csy #(
      .SYMBOLS_PER_BEAT (1),
    ...
    qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_qrbnrzi #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_d35qd7q #(
             .SYMBOLS_PER_BEAT (1),
