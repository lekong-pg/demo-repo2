// qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_hykem2a.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_hykem2a #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 13,
		...
		input  wire [12:0] in_data,   //          .data
		input  wire        out_ready, //   source0.ready
		output wire        out_valid, //          .valid
		output wire [12:0] out_data   //          .data
	);
	...
	qsys_top_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),   //   input,  width = 13,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 13,          .data
