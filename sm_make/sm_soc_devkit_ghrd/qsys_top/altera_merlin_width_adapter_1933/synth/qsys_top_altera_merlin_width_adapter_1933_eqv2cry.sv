...
module qsys_top_altera_merlin_width_adapter_1933_eqv2cry 
#(
...
( 
    ...
    //OOO purpose added two fields in merlin packet sop and eop
   ...
   generate
      ...
      if (IN_NUMSYMBOLS > OUT_NUMSYMBOLS)  begin
         ...
         //OOO sop and eop padding at MSB
       if( ENABLE_OOO ) begin  
         always @* begin         
            if (cmd_burst_size > OUT_NUMSYMBOLS)begin
        ...
        if (SYNC_RESET == 0) begin : async_rst1
         ...
         always @* begin
           ...
           if (in_size_field < in_ori_size_field) begin // downsize happen on command path, the response need packing
            ...
            //OOO sop and eop bits will set to '1 becuase of no chopping command
            if( ENABLE_OOO ) begin
               out_sop_ooo_field    = 1;
               out_eop_ooo_field    = 1; 
            end            
