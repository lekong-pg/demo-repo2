	ocm u0 (
		...
		.s1_arid    (_connected_to_s1_arid_),    //   input,   width = 10, axi_s1.arid
		.s1_araddr  (_connected_to_s1_araddr_),  //   input,   width = 18,       .araddr
		...
		.s1_awid    (_connected_to_s1_awid_),    //   input,   width = 10,       .awid
		.s1_awaddr  (_connected_to_s1_awaddr_),  //   input,   width = 18,       .awaddr
		...
		.s1_rid     (_connected_to_s1_rid_),     //  output,   width = 10,       .rid
		.s1_rdata   (_connected_to_s1_rdata_),   //  output,  width = 128,       .rdata
		...
		.s1_wdata   (_connected_to_s1_wdata_),   //   input,  width = 128,       .wdata
		.s1_wstrb   (_connected_to_s1_wstrb_),   //   input,   width = 16,       .wstrb
		...
		.s1_bid     (_connected_to_s1_bid_),     //  output,   width = 10,       .bid
