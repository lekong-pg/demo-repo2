module emif_hps (
		...
		output wire         emif_mem_0_mem_odt,      //               .mem_odt
		output wire         emif_mem_0_mem_cs_n,     //               .mem_cs_n
		output wire [16:0]  emif_mem_0_mem_a,        //               .mem_a
		output wire [1:0]   emif_mem_0_mem_ba,       //               .mem_ba
		output wire         emif_mem_0_mem_bg,       //               .mem_bg
		output wire         emif_mem_0_mem_act_n,    //               .mem_act_n
		output wire         emif_mem_0_mem_par,      //               .mem_par
		input  wire         emif_mem_0_mem_alert_n,  //               .mem_alert_n
