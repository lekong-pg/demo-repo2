// emif_hps_emif_ph2_600_mtzi73i.v
...
`timescale 1 ps / 1 ps
module emif_hps_emif_ph2_600_mtzi73i (
		input  wire         ref_clk_0,               //             ref_clk_0.clk
		output wire         noc_aclks0,              //           s0_noc_aclk.clk
		input  wire [39:0]  s0_axi4_araddr,          //           s0_noc_axi4.araddr
		...
		output wire         s0_noc_axi4lite_clk,     //       s0_noc_axil_clk.clk
		output wire         s0_noc_axi4lite_rst_n,   //     s0_noc_axil_rst_n.reset_n
		input  wire [26:0]  s0_noc_axi4lite_awaddr,  // s0_noc_axil_axi4_lite.awaddr
		...
		output wire         out_resets0_n            //          s0_noc_rst_n.reset_n
	);
	...
	emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi #(
		...
		.noc_aclk_0           (noc_aclks0),                                //  output,      width = 1,      noc_aclk_0.clk
		.noc_rst_n_0          (out_resets0_n),                             //  output,      width = 1,     noc_rst_n_0.reset_n
		...
		.core_init_n_0        (1'b0),                                      // (terminated),                                 
		.i3c_scl_0            (),                                          // (terminated),                                 
		.i3c_sda_0            ()                                           // (terminated),                                 
	);

	emif_hps_emif_ph2_cal_400_55d3puq calip_0 (
		...
		.s0_noc_axi4lite_awaddr      (s0_noc_axi4lite_awaddr),                    //   input,     width = 27, s0_noc_axi4lite_axi4_lite.awaddr
		...
		.tniul_rst_n                 (out_resets0_n)                              //   input,      width = 1,               tniul_rst_n.reset_n
	);
