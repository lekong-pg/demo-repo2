	component emif_hps is
		port (
			...
			emif_mem_0_mem_odt      : out   std_logic;                                         -- mem_odt
			emif_mem_0_mem_cs_n     : out   std_logic;                                         -- mem_cs_n
			emif_mem_0_mem_a        : out   std_logic_vector(16 downto 0);                     -- mem_a
			emif_mem_0_mem_ba       : out   std_logic_vector(1 downto 0);                      -- mem_ba
			emif_mem_0_mem_bg       : out   std_logic;                                         -- mem_bg
			emif_mem_0_mem_act_n    : out   std_logic;                                         -- mem_act_n
			emif_mem_0_mem_par      : out   std_logic;                                         -- mem_par
			emif_mem_0_mem_alert_n  : in    std_logic                      := 'X';             -- mem_alert_n
	...
	u0 : component emif_hps
		port map (
			...
			emif_mem_0_mem_odt      => CONNECTED_TO_emif_mem_0_mem_odt,      --               .mem_odt
			emif_mem_0_mem_cs_n     => CONNECTED_TO_emif_mem_0_mem_cs_n,     --               .mem_cs_n
			emif_mem_0_mem_a        => CONNECTED_TO_emif_mem_0_mem_a,        --               .mem_a
			emif_mem_0_mem_ba       => CONNECTED_TO_emif_mem_0_mem_ba,       --               .mem_ba
			emif_mem_0_mem_bg       => CONNECTED_TO_emif_mem_0_mem_bg,       --               .mem_bg
			emif_mem_0_mem_act_n    => CONNECTED_TO_emif_mem_0_mem_act_n,    --               .mem_act_n
			emif_mem_0_mem_par      => CONNECTED_TO_emif_mem_0_mem_par,      --               .mem_par
			emif_mem_0_mem_alert_n  => CONNECTED_TO_emif_mem_0_mem_alert_n,  --               .mem_alert_n
