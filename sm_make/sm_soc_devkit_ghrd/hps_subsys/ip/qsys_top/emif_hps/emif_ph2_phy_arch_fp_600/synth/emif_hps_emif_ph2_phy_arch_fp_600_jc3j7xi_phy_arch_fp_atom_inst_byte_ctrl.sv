...
module emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_phy_arch_fp_atom_inst_byte_ctrl #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_byte_ctrl::*;
   ...
   assign {i_phyctrl_dqsnin_x16_clk,i_phyctrl_dqspin_x16_clk} = bc_to_bc_x16_in;
...
`define byte_ctrl_pinX_params(X)                                                           \
            .pin``X``_rx_coarse_delay             (PIN_RX_COARSE_DELAY       [ID][``X``]), \
            .pin``X``_rx_fine_delay               (PIN_RX_FINE_DELAY         [ID][``X``]), \
            .pin``X``_rx_usage                    (PIN_RX_USAGE              [ID][``X``]), \
            .pin``X``_tx_coarse_delay             (PIN_TX_COARSE_DELAY       [ID][``X``]), \
            .pin``X``_tx_fine_delay               (PIN_TX_FINE_DELAY         [ID][``X``]), \
