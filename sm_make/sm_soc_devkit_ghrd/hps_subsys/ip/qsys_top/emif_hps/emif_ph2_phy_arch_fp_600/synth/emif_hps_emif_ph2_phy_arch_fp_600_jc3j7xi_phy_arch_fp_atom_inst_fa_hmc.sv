...
module emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_phy_arch_fp_atom_inst_fa_hmc #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::*;
   import emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_p2c_hmc::*;
   ...
   begin
      ...
      if (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::IS_USED[ID])
      begin : gen_hmc_c2p_fa
         tennm_hmc_c2p_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode                  (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
      ...
      if (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_p2c_hmc::IS_USED[ID])
      begin : gen_hmc_p2c_fa

         tennm_hmc_p2c_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode                  (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_p2c_hmc::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
      ...
      if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 100) && (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 225) && (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 350) && (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_c2p_hmc::IS_USED[ID]))
   ...
   generate
   begin
      if ((P2C_REGISTER_STAGE > 0) && (emif_hps_emif_ph2_phy_arch_fp_600_jc3j7xi_atom_attr_fa_p2c_hmc::IS_USED[ID]))
