...
module emif_hps_emif_ph2_cal_arch_fp_400_rrp6sxa_cal_arch_fp_top #(
...
//// User Interface directy from Fabric (M)
   ...
   emif_hps_emif_ph2_cal_arch_fp_400_rrp6sxa_stdfn_inst_iossm #(
   ) u_iossm (
   ...
   emif_hps_emif_ph2_cal_arch_fp_400_rrp6sxa_stdfn_inst_seq #(
   ) u_seq (
   ...
   tennm_compensation_block u_comp_block (
      // synthesis translate_off
