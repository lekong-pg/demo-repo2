...
module emif_hps (
	...
	emif_hps_emif_hps_ph2_600_pwhrmka emif_hps_ph2_inst (
		.noc_aclk_0              (noc_aclk_0),              //  output,    width = 1,      usr_clk_0.clk
		.s0_axi4_araddr          (s0_axi4_araddr),          //   input,   width = 40,        s0_axi4.araddr
		...
		.emif_mem_0_mem_ck_t     (emif_mem_0_mem_ck_t),     //  output,    width = 1,     emif_mem_0.mem_ck_t
		.emif_mem_0_mem_ck_c     (emif_mem_0_mem_ck_c),     //  output,    width = 1,               .mem_ck_c
		.emif_mem_0_mem_cke      (emif_mem_0_mem_cke),      //  output,    width = 1,               .mem_cke
		.emif_mem_0_mem_odt      (emif_mem_0_mem_odt),      //  output,    width = 1,               .mem_odt
		.emif_mem_0_mem_cs_n     (emif_mem_0_mem_cs_n),     //  output,    width = 1,               .mem_cs_n
		.emif_mem_0_mem_a        (emif_mem_0_mem_a),        //  output,   width = 17,               .mem_a
		.emif_mem_0_mem_ba       (emif_mem_0_mem_ba),       //  output,    width = 2,               .mem_ba
		.emif_mem_0_mem_bg       (emif_mem_0_mem_bg),       //  output,    width = 1,               .mem_bg
		.emif_mem_0_mem_act_n    (emif_mem_0_mem_act_n),    //  output,    width = 1,               .mem_act_n
		.emif_mem_0_mem_par      (emif_mem_0_mem_par),      //  output,    width = 1,               .mem_par
		.emif_mem_0_mem_alert_n  (emif_mem_0_mem_alert_n),  //   input,    width = 1,               .mem_alert_n
		.emif_mem_0_mem_reset_n  (emif_mem_0_mem_reset_n),  //  output,    width = 1,               .mem_reset_n
		.emif_mem_0_mem_dq       (emif_mem_0_mem_dq),       //   inout,   width = 32,               .mem_dq
		.emif_mem_0_mem_dqs_t    (emif_mem_0_mem_dqs_t),    //   inout,    width = 4,               .mem_dqs_t
		.emif_mem_0_mem_dqs_c    (emif_mem_0_mem_dqs_c),    //   inout,    width = 4,               .mem_dqs_c
		.emif_oct_0_oct_rzqin    (emif_oct_0_oct_rzqin),    //   input,    width = 1,     emif_oct_0.oct_rzqin
		.s0_noc_axi4lite_clk     (s0_noc_axi4lite_clk),     //  output,    width = 1,    s0_axil_clk.clk
		.s0_noc_axi4lite_rst_n   (s0_noc_axi4lite_rst_n),   //  output,    width = 1,  s0_axil_rst_n.reset_n
		.s0_noc_axi4lite_awaddr  (s0_noc_axi4lite_awaddr),  //   input,   width = 27,        s0_axil.awaddr
		...
		.out_reset_0_n           (out_reset_0_n),           //  output,    width = 1,    usr_rst_n_0.reset_n
		.emif_ref_clk_0_clk      (emif_ref_clk_0_clk)       //   input,    width = 1, emif_ref_clk_0.clk
	);
