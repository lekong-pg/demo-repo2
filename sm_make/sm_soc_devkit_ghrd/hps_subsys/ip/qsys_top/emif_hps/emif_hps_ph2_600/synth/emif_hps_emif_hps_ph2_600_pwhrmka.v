// emif_hps_emif_hps_ph2_600_pwhrmka.v
...
`timescale 1 ps / 1 ps
module emif_hps_emif_hps_ph2_600_pwhrmka (
	...
	emif_hps_emif_ph2_600_mtzi73i emif (
		...
		.mem_odt_0               (emif_mem_0_mem_odt),                        //  output,    width = 1,                      .mem_odt
		.mem_cs_n_0              (emif_mem_0_mem_cs_n),                       //  output,    width = 1,                      .mem_cs_n
		.mem_a_0                 (emif_mem_0_mem_a),                          //  output,   width = 17,                      .mem_a
		.mem_ba_0                (emif_mem_0_mem_ba),                         //  output,    width = 2,                      .mem_ba
		.mem_bg_0                (emif_mem_0_mem_bg),                         //  output,    width = 1,                      .mem_bg
		.mem_act_n_0             (emif_mem_0_mem_act_n),                      //  output,    width = 1,                      .mem_act_n
		.mem_par_0               (emif_mem_0_mem_par),                        //  output,    width = 1,                      .mem_par
		.mem_alert_n_0           (emif_mem_0_mem_alert_n),                    //   input,    width = 1,                      .mem_alert_n
	...
	emif_hps_altera_gpio_2200_yh2w5qy refclk_gpio (
	...
	emif_hps_qsys_interface_bridge_10_ujh3egy conversion_bridge (
