// peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_xrcxq7y.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_xrcxq7y #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 119,
		...
		input  wire [118:0] in_data,           //          .data
		input  wire         out_ready,         //   source0.ready
		output wire         out_valid,         //          .valid
		output wire         out_startofpacket, //          .startofpacket
		output wire         out_endofpacket,   //          .endofpacket
		output wire [118:0] out_data           //          .data
	);

	peripheral_subsys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 119,          .data
		...
		.out_data          (out_data),          //  output,  width = 119,          .data
