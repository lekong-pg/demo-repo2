...
module peripheral_subsys_altera_merlin_axi_slave_ni_1971_zovv3rq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_m3ojhla #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ufj2aqq #(
      .SYMBOLS_PER_BEAT (1),
    ...
    peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_qv4qemy #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       peripheral_subsys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_xrcxq7y #(
             .SYMBOLS_PER_BEAT (1),
